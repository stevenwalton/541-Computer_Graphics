...
/****************************************************/
/*                 Student Code                     */
/*     You will write your code in this section     */
/****************************************************/
__global__
...
{
    /*
       Must take in rgbaImage and access the correct 
       rgb data (note, it is an unsigned char4
...
{
    /*
       Set the correct block size and grid size to speed up
     */
